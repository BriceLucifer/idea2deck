...
Remove temporary artifacts after successful verification. On failure, retain only the minimum diagnostic material needed to explain or repair the blocker.
